...
<div class="product_input_l" style="width: 98%; margin-top: 10px;">
	<div style="clear: both;">
		<ul id="catmenu" class="catmenu">
			...
			<li><a href="<?= base_url() ?>admin/list_products">List Products</a>
			</li>
			<li><a href="<?= base_url() ?>admin/add_product">Add New Product</a>
			</li>
			...
			<li><a href="<?= base_url() ?>backend/manuals_admin">Instruction
					Manuals Admin</a></li>
			<li><a href="<?= base_url() ?>backend/tradereviews_admin">Trade
					Reviews Admin</a></li>
			<li><a href="<?= base_url() ?>backend/cart_admin">Manage Shopping
					Carts</a></li>

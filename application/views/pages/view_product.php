        ...
        <?php if ($features != NULL) { ?>
            <div id="keyFeatures"  >
                ...
                <?php foreach ($features as $row): ?>
                    ...
                    <img  <?php if($row->feature_description == NULL) { } else { ?>class="tooltip" <?php }?> title="<?=$row->feature_description?>" style="float:left; margin:0px;  width:80%;" src="<?= base_url() ?>images/icons/features/<?= $row -> feature_image ?>"/>

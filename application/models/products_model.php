<?php
	...
	class Products_model extends CI_Model
	{
		...
		function add_attribute()
		{
			...
			// TODO check if attribute is already part of product, and instead of adding
			// again,
		...
		function search_products($term)
		{
			...
			switch($parts)
			{
				...
				case 1 :
					...
					$this -> db -> or_like('CONCAT(product_desc, " ", product_name)', $term);
		...
		function create_new_spec($spec)
		{
			...
			$new_spec_entry = array('spec_desc' => trim($spec), );
		...
		function create_other_feature($feature)
		{
			...
			$new_other_feature_entry = array('other_feature_name' => trim($feature), );
